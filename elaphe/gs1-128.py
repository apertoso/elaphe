...
GS1_128_ESCAPE_RE = re.compile(r'\^\d{3}')
GS1_128_CHARS =" !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~"
class GS1128(Barcode):
    ...
    class _Renderer(LinearCodeRenderer):
            ...
            while idx<len(codestring):
                if codestring[idx] == '^':
                    ...
                    if mode==2:
                        ...
                        code_i = GS1_128_CHARS.find(codestring[idx])
                        idx += 1
        ...
        def build_params(self, codestring):
            params = super(GS1128._Renderer, self).build_params(codestring)
